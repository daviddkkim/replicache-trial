...
async function processMutation(t: pgPromise.ITask<{}>, clientID:string , spaceID: string, mutation: any, error?: any) {
...
export async function getLastMutationID(t: pgPromise.ITask<{}>, clientID: string, required: boolean) {
...
async function setLastMutationID(t: pgPromise.ITask<{}>, clientID: string, mutationID: number) {
...
async function createMessage(t: pgPromise.ITask<{}>, {id, from, content, order}: Message, spaceID: string, version: string) {
  await t.none(
    `insert into message (
